...
# which is loopback-only on the control-plane host. control-host reaches it
# through a dedicated reverse-tunnel LaunchAgent; gpu-host has
...
#
#   scripts/publish-linux-host-beacon.sh gpu-host
#
