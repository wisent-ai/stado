...
def main():
    ...
    payload = {
        ...
        "context": {
            ...
            "operation": (
                "signs the tailnet object proxy certificate on charless-mac-mini; "
                "anchored by charless-mac-mini, lukasz-macbook and "
                "ubuntu-server-rtx-pro-6000 as storage.stado.ca_file"
            ),
        },
    }
