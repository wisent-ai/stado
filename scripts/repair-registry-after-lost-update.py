...
AUTHORITY_ACCOUNT = ("control-host", "host-account-control-host")
UNTRUE_SERVICE = ("operator-host", "com.wisent.always-on.weles")
DROP_ENDPOINT = ("stado-object-api", "operator-host")
