...
def main():
    ...
    print("  2026-08-14  `stado host install-credential operator-host <item> <field> <name>`")
    print("              answered HTTP 403 `consumer not authorized to read item field`")
    print("              for host-account-control-host#password AND for")
    ...
    print("              operator-host and control-host both have one, with the same")
