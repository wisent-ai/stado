...
- **Remote profile migration:** `stado host config-migrate TARGET` runs the installed configuration migration through the fleet channel, preserving the prior profile before an operator updates a worker's object-service route.
