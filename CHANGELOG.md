...
- **Delivery diagnostics:** a required delivery failure includes its queue job identity and the already recorded command failure and output, rather than dropping the cause from the submit command's error.
