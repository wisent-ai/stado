...
The local `lukasz-macbook` agent currently starts, initializes `JobStorage`, receives the same GCS 403 before queue processing, exits, and is restarted by launchd roughly every 11–13 seconds.
