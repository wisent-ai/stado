...
mod tests {
    ...
    fn managed_versions_is_optional_and_round_trips() {
        ...
        // declaration is written back where it was read from. The key here is
        // deliberately one this struct does not model: `role` would prove
        // nothing, because it is a field.
        assert_eq!(
            target.extra["operator_note"],
