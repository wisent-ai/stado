//! The remote program that reclaims regenerable build caches, and its
//! parsers.
//!
...
//!
//! Nothing here reaches a machine: [`super::hosts`] owns the declaration a
//! target resolves to and the commands that run this program on one.
