...
mod tests {
    ...
    fn the_shipped_declaration_carries_the_three_products_the_fleet_runs() {
        ...
        assert_eq!(unit.label_for("charless-mac-mini"), "com.wisent.weles-worker");
        assert_eq!(
            unit.path_for("charless-mac-mini").as_deref(),
    ...
    fn the_declared_agent_label_is_the_one_the_installer_creates() {
        ...
        for host in ["charless-mac-mini", "lukasz-macbook"] {
            assert_eq!(
                unit.label_for(host),
