...
const ECHO_PRODUCTION_DOMAIN: &str = "content.wisent.ai";
...
const RETIRED_ENV: &[&str] = &[
    ...
    "CONTENT_PLATFORM_AGENT_AUTH_SECRET",
    "CONTENT_PLATFORM_DELIVERY_SIGNING_SECRET",
    "CONTENT_PLATFORM_MEDIA_ROUTER_TOKEN",
    "CONTENT_PLATFORM_MODEL_ROUTER_TOKEN",
    "DOWNLOAD_API_KEY",
    "ELEVENLABS_API_KEY",
    "GCP_SERVICE_ACCOUNT",
    "GEMINI_API_KEY",
