...
use super::skarbiec::{
    ...
    SERVICE_API_DEPLOYERS_CONFIG, SERVICE_API_SKARBIEC,
};
...
pub const CONTROL_CONFIG: &[ConfigField] = &[
    ...
    RELEASE_PUBLISHER_SKARBIEC.url,
    RELEASE_PUBLISHER_SKARBIEC.consumer,
    RELEASE_PUBLISHER_SKARBIEC.token_file,
