...
assert.match(stdout, /build_recipe_polls_public_git_runs_on_matching_worker_and_publishes_artifact \.\.\.[\s\S]*\nok\n/);
assert.match(stdout, /verified recipe=probierz-native-build; job=.+; platform=darwin-arm64; artifact=build-output.txt/);
