...
//! graphical session, and the two states control-host has been in:
//!
...
impl Harness {
    /// A temp root with the fake host seeded for the state control-host is
...
/// The blast radius. Every Stado service on control-host runs
