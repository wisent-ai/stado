//! The built binary, end to end: a real `stado resolver resolve` against an
//! authority whose name cannot resolve, and the refusal it publishes with
//! the same sentence the command printed.
