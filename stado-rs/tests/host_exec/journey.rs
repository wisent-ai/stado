//! The isolated journey: a repository-rooted evidence directory, a private
//! config and registry naming this machine, the product invocation that
//! retains every process result, and the read that proves neither document
//! moved.
...
use crate::story::{native_story, NativeStory};
