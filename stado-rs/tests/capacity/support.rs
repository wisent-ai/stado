//! The isolated fleet every capacity story publishes into, and the readers
//! each story uses to see what the product published.
...
pub(crate) const TARGET: &str = "capacity-runner";
...
impl Journey {
    ...
    pub(crate) fn submit_blocked(&self, name: &str) -> String {
