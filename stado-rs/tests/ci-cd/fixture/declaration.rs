//! The source this journey releases, and the registry that describes where it
//! goes: one product, one runner, one service, all inside the fixture home.

use super::super::*;

use super::{profile, signing};
