//! Talking to the dashboard the fixture started: waiting until it answers,
//! one request with or without a bearer, minting a verifier token, and the
//! endpoint every call is made against.
