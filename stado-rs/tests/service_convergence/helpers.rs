//! What both stories read about the machine they run on: the binary's own
//! version, the next patch after it, where a release stages, this host's
//! name, a free loopback port, a digest, and the error envelope check.
...
use crate::fixture::{Answer, HOST, PATH_ENV};
