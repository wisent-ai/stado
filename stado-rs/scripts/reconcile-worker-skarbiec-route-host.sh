...
"$tailscale" serve status --json \
  | /usr/bin/jq -e '.Web["control-host.tail6443b3.ts.net:9443"].Handlers["/"].Proxy == "http://127.0.0.1:8895"'
printf '%s\n' 'worker Skarbiec route: https://control-host.tail6443b3.ts.net:9443 -> http://127.0.0.1:8895'
